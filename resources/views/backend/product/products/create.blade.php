                    ...
                    <div class="tab-pane fade" id="price_and_stocks" role="tabpanel"
                        ...
                        <div class="bg-white p-3 p-sm-2rem">
                            ...
                            <div class="w-100">
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-xxl-3 col-form-label fs-13">{{ translate('Current Gold Rate (18 Carat)') }}</label>
                                    <div class="col-xxl-9 d-flex align-items-center">
                                        <input type="number" class="form-control me-2" id="gold_rate" name="gold_rate"
                                            value="{{ $goldRate }}" readonly>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row">
                                    <label
                                        class="col-xxl-3 col-form-label fs-13">{{ translate('Diamond Price') }}</label>
                                    <div class="col-xxl-9">
                                        <input type="number" id="diamond_price" name="diamond_price"
                                ...
                                <div class="form-group row">
                                    <label class="col-md-3 col-from-label">{{translate('Unit price')}} <span
                                            class="text-danger">*</span></label>
                                    <div class="col-md-6">
                                        <input type="number" id="unit_price" lang="en" min="0" value="0" step="0.01"
                                ...
                                <div id="show-hide-div">
                                    ...
                                    <div class="form-group row">
                                        <label class="col-md-3 col-from-label">{{translate('Quantity')}} <span
                                                class="text-danger">*</span></label>
                                        <div class="col-md-6">
                                            <input required type="number" lang="en" min="1" value="1" step="1"
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        function calculateUnitPrice() {
            ...
            let goldRate = parseFloat($('#gold_rate').val());

            if (isNaN(goldRate)) {
                goldRate = $('#gold_rate').attr('value') || 0;  // Fallback to the attribute or default to 0
            }
